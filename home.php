...
$phone=$_SESSION['logindboy'];
$pass=$_SESSION['loginpassdboy'];

$sql1="SELECT * FROM `dboy`where  dphone='$phone' AND dpass='$pass' AND did='$did'";
...
<body class="bg-white" onload="post();">
   ...
   <!-- loader -->
    ...
    <div class="appHeader ">
        ...
        <div class="right">
                ...
                <?php if($dstatus==1){ ?>
                <a href="onoff.php?did=<?php echo $did; ?>&&status=0">
                <button class="btn btn-success">Available</button>  </a>
                <?php }else{ ?>
                <a href="onoff.php?did=<?php echo $did; ?>&&status=1">
                <button class="btn btn-danger">Not Available</button> </a><?php };?>
...
<table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <?php
                        $qry="SELECT * FROM `orders` WHERE did=$did AND dchargestatus=0 ORDER BY oid DESC";
...
<!--<?php }; ?>-->
                         ...
                         <td><h4>Rs.<?php  echo $res['dcharge']; echo "<br>";
                         if($res['dchargestatus']==0) echo "(Due)";
                         ?><br></h4>   
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <ul class="listview flush transparent no-line image-listview mt-2">
                        <li>
                            <br>
                            <a href="home.php?aid=<?php echo $aid; ?>" class="item">
                        ...
                        <!--</li>-->
                        <li>
                            <a href="allorders.php?aid=<?php echo $aid; ?>&&did=<?php echo $did; ?>" class="item">
                                <div class="icon-box bg-primary">
                                    <ion-icon name="chatbubble-ellipses-outline"></ion-icon>
                                </div>
                                <div class="in">
                        ...
                        <li>
                            <a href="notify.php?aid=<?php echo $aid; ?>&&did=<?php echo $did; ?>" class="item">
                                <div class="icon-box bg-primary">
                                    <ion-icon name="chatbubble-ellipses-outline"></ion-icon>
                                </div>
                                <div class="in">
                ...
                <div class="sidebar-buttons">
                    ...
                    <a href="logout.php?aid=<?php echo $aid; ?>" class="button">
