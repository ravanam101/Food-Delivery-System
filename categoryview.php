...
include 'pay/db.php';
$cid=$_GET['cid'];
$qry="SELECT * FROM `subscription` where aid=1";
$row=mysqli_query($conn,$qry);
$res5=mysqli_fetch_assoc($row);
$style=$res5['styleservice'];
$stylecat=$res5['stylecat'];
        ...
        $two="DESC";
        $array = array($one, $two);
$order= $array[rand(0, count($array) - 1)];
...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="header-large-title"><br>
            <!--<img src="bnr.gif" alt="logo" width="525" height="55"><br>-->
            <!--<h1 class="title">Discover</h1>-->
            <!--<h3 class="subtitle">Explore Categories</h3>-->
    ...
    <div class="header-large-title">
            <!--<h1 class="title">Discover</h1>-->
            <h3 class="subtitle">Fresh Recomendation for you</h3>
            
        </div>
    <?php 
    if($style==0){
    $sql="SELECT * FROM `category`WHERE cid=$cid  ORDER BY `cid` $order"; 
    ...
    ?>
        <div class="tab-pane fade show active" id="feed" role="tabpanel">
            ...
            <div class="mt-2 pr-2 pl-2">
                 <!--<h3 class="subtitle"><?php echo $res['cname'];?></h3>-->
                <div class="row">
                    <?php 
                    $cid=$res['cid'];
                        $sql1="SELECT * FROM `ads` WHERE cid=$cid"; 
                    ...
                    <div class="col-6 mb-3">
                        ...
                        <img src="admin/<?php echo $res1['aimage'];?>" alt="image"  width="90" height="90"><br>
                         <?php
                         $str = $res1['aname'];
                         
                         echo $str{0}.$str{1}.$str{2}.$str{3}.$str{4}.$str{5}.$str{6}.$str{7}.$str{8}.$str{9}.$str{10}.$str{11}."...";?><br>
                         👁 120 views<br>
                         <b>₹ <?php echo $res1['aprice'];?></b>
                    </div>
                    </div></div>
                    <?php } ?>
                </div>
...
$ch= $array[rand(0, count($array) - 1)];
        ?>
        <div class="section mt-3 mb-3">
            <div class="card">
                <img src="assets/img/sample/photo/<?php echo $ch;?>" class="card-img-top" alt="image">
                <div class="card-body">
