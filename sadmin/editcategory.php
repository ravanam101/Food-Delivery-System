...
?>
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="https://cdn-icons-png.flaticon.com/512/3502/3502688.png" alt="image" class="form-image">
            </div>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                           <input type="hidden" name="cid" value="<?php echo $cid;?>">
                            ...
                            <input type="text" class="form-control" value="<?php echo $row['cname'];?>" name="catname" placeholder="Category Name to add" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div><br>
                        <div class="input-wrapper">
                            <input type="file" name="uploadfile" class="form-control" value="<?php echo $row['cimage'];?>" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
