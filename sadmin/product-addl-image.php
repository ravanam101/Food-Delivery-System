...
?>
    ...
    <div class="appHeader ">
        ...
        <div class="right">
           <a href="addimages.php?pid=<?php  echo $pid;?>"><button class="btn btn-outline-dark btn-sm">Add Images</button></a>
            </a>
        </div>
...
<table class="table table-striped table-hover">
                ...
                <tbody>
                   <?php
                        $qry="SELECT * FROM `addl_image` WHERE pid=$pid ORDER BY `id` DESC";
                        $raw=mysqli_query($conn,$qry);
                        while($res=mysqli_fetch_array($raw)){?>
                    
                    <tr>
                        <td><?php echo $res['id']; ?></td>
                        <td><img src="./images/<?php echo $res['image']; ?>" height="30" width="30">
                        </td>
                        
                        <td>
                            <a href="deleteimage.php?pid=<?php  echo $pid;?>&&id=<?php echo $res['id']; ?>">
                            <button class="btn btn-outline-dark btn-sm">Delete</button></a></td>                        
