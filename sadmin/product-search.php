...
<table class="table table-striped table-hover">
                ...
                <tbody>
                   <?php
                        $qry="SELECT * FROM `products`WHERE pname LIKE '%$search%' ORDER BY `pid` DESC";
                    ...
                    <tr>
                        ...
                        <td><?php echo $res['pid']; ?> <a href="product-image-update.php?pid=<?php echo $res['pid']; ?>"><img src="<?php  echo $res['pimage'];?>" height="30" width="30" class="rounded-circle"></td></a>
                        <?php }else{ ?>
