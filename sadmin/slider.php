...
?>
    ...
    <div class="appHeader ">
        ...
        <div class="right">
           <a href="addslider.php"><button class="btn btn-outline-dark btn-sm">Add Slider</button></a>
            </a>
        </div>
                ...
                <tbody>
                   <?php
                    ...
                    <tr>
                        ...
                        <td><img src="./images/<?php  echo $res['simage'];?>" height="50" width="100" class="rounded"> </td>
                        
                         <td><?php  echo $res['slink'];?> </td>
                         <td>
                        <a href="deleteslider.php?sid=<?php echo $sid;?>">
