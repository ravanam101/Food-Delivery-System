    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            ...
            <div class="section mt-1 mb-5">
                <form action="processslider.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group boxed">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" class="form-control" name="slink" placeholder="Link a Product Id" required>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
