...
$uploadfile=mysqli_real_escape_string($conn,$_POST['uploadfile']);
 ...
 $filename = $_FILES["uploadfile"]["name"];
    ...
    $sql = "UPDATE `settings` SET `applogo` = '$filename' WHERE `settings`.`id` = 1;";
...
<br><br>
        <div class="login-form mt-1">
            <div class="section">
                <img src="https://www.gisaxiom.com/assets/images/training/image-editor.svg" alt="image" class="form-image">
            </div>
