...
?>
    ...
    <div class="appHeader ">
        ...
        <div class="right">
           <a href="addcategory.php"><button class="btn btn-outline-dark btn-sm">Add category</button></a>
            </a>
        </div>
...
<table class="table table-striped table-hover">
                ...
                <tbody>
                   <?php
                    ...
                    <tr>
                        <td><?php echo $cid=$res['cid']; ?></td>
                        <td><?php  echo $res['cname'];?> </td>
                        <td><img src="./images/<?php  echo $res['cimage'];?>" height="50" width="50" class="rounded-circle"> </td>
                        <td>
                        <a href="editcategory.php?cid=<?php echo $cid;?>">
                            <button class="btn btn-outline-primary btn-sm">Update</button></a>
                            <br><br>
                        <a href="deletecategory.php?cid=<?php echo $cid;?>">
